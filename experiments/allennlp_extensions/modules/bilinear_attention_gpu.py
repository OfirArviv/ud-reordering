...
@Attention.register("bilinear_cuda")
class BilinearAttentionCuda(Attention):
    """
    ...
    def __init__(
        ...
        self._weight_matrix = Parameter(torch.Tensor(vector_dim, matrix_dim).cuda())
        self._bias = Parameter(torch.Tensor(1).cuda())
