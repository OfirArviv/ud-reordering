...
@DatasetReader.register("seq2seq_length_filtering")
class Seq2SeqDatasetReaderWithLengthFiltering(DatasetReader):
    """
    ...
    def _read(self, file_path: str):
        ...
        if self._target_max_tokens and self._target_max_exceeded:
            logger.info(
                "In %d instances, the target token length exceeded the max limit (%d) and were skipped.",
