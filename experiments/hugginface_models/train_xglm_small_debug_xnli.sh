...
export action="train"
export model_id="facebook/xglm-564M"
...
export output_dir="temp_outputs/xglm_564m_xnli_tryout/en_standard_1"
export use_lora=1
export use_qlora=1
...
sbatch -J xglm_s_xnli experiments/hugginface_models/run_subscript.sh
