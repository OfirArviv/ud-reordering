...
export valid_data_path="$dataset_dir"/seq2seq_standard/english_dev_2000.tsv
...
do
   ...
   do
     ...
     export test_data_path="$dataset_dir"/$subdir/english_dev_2000_reordered_by_"$lang"_"$algo".tsv
