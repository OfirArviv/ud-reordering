...
dataset_dir=experiments/processed_datasets/smiler_10k/
# Standard Order Model
export train_data_path="$dataset_dir"/standard/en-full_corpora_train.tsv.json
export valid_data_path="$dataset_dir"/standard/en-full_corpora_test.tsv.json
...
do
  ...
  do
    ...
    do
      export train_data_path="$dataset_dir"/"$subdir"/en-full_corpora_train_reordered_by_"$lang"_"$algo""$combined_postfix".tsv.json
      export valid_data_path="$dataset_dir"/"$subdir"/en-full_corpora_test_reordered_by_"$lang"_"$algo""$combined_postfix".tsv.json
