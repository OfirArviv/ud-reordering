...
export vocab_path="experiments/vocabs/multilingual_top_pointers"
...
dataset_dir=experiments/processed_datasets/multilingual_top/pointers_format/
...
export test_data_path="$dataset_dir"/standard/english_dev_decoupled_format.tsv
...
sbatch $sbatch_params -J train_multi_top experiments/scripts/train_scripts/train_subscript.sh
...
do
  ...
  do
    ...
    do
      ...
      export valid_data_path=null
      export test_data_path="$dataset_dir"/"$subdir"/english_dev_decoupled_format_reordered_by_"$lang"_"$algo""$combined_postfix".tsv
