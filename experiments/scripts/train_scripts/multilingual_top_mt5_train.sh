...
dataset_dir=experiments/processed_datasets/multilingual_top/non_pointer_format/
...
sbatch $sbatch_params --reservation 5783 -J train_multi_top experiments/scripts/train_scripts/train_subscript.sh
