...
export test_dir="experiments/processed_datasets/smiler/test_normalized_32_rels/"
...
sbatch $sbatch_params -J eval_smiler experiments/scripts/evaluate_scripts/eval_subscript.sh

# Reordered Models
combined_postfixes=("" "_combined")
languages=(arabic korean persian "persian_0")
