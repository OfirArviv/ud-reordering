...
export test_dir="experiments/processed_datasets/tacred_small/standard_split"
...
export model_dir="experiments_results/models/re_tacred/finetuned/english_reordered_by_korean_HUJI_combined_finetuned_200"
sbatch $sbatch_params -J eval_tacred experiments/scripts/evaluate_scripts/eval_subscript.sh
