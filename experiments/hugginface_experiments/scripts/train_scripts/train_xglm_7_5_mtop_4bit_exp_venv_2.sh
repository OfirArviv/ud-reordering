...
sbatch $sbatch_params -J exp_ experiments/hugginface_experiments/scripts/train_scripts/train_subscript_4bit_experiments_venv_2.sh
...
sbatch $sbatch_params -J exp1 experiments/hugginface_experiments/scripts/train_scripts/train_subscript_4bit_experiments_venv_2.sh
...
sbatch $sbatch_params -J exp2 experiments/hugginface_experiments/scripts/train_scripts/train_subscript_4bit_experiments_venv_2.sh
...
sbatch $sbatch_params -J exp3 experiments/hugginface_experiments/scripts/train_scripts/train_subscript_4bit_experiments_venv_2.sh
...
sbatch $sbatch_params -J exp4 experiments/hugginface_experiments/scripts/train_scripts/train_subscript_4bit_experiments_venv_2.sh
...
sbatch $sbatch_params -J exp5 experiments/hugginface_experiments/scripts/train_scripts/train_subscript_4bit_experiments_venv_2.sh
...
sbatch $sbatch_params -J exp6 experiments/hugginface_experiments/scripts/train_scripts/train_subscript_4bit_experiments_venv_2.sh
