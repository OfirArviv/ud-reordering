...
python "$PWD"/experiments/hugginface_experiments/src/run_2.py train --model-id  "$model_id" --train-dataset-path "$train_dataset_path"  --output-dir "$output_dir" --seed "$RANDOM" $extra_params
