...
def train_model(model_id: str,
    ...
    training_args = Seq2SeqTrainingArguments(
        ...
        per_device_train_batch_size= 1 if train_in_8_bit else 8,  # if "base" in model_id else 1,
        ...
        fp16=True,
        gradient_accumulation_steps=2 if train_in_8_bit else 4,  # if "base" in model_id else 16,
